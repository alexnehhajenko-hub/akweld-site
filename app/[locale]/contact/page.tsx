          ...
          >
            ...
            <div>
              <h2 style={{ margin: 0, fontSize: 24 }}>
                {ru ? "Контактное лицо" : "Contact person"}
              </h2>
              ...
              >
                {ru
                  ? "По вопросам сотрудничества, расчёта, производства, монтажа и проектов пишите напрямую на основной email компании."
                  : "For cooperation, estimates, fabrication, installation and project questions, please write directly to the company’s main email."}
              </p>
